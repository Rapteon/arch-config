...
9. Install essential packages
   1. # pacstrap /mnt base linux-zen linux-firmware neovim dhcpcd man-db man-pages texinfo iwd zsh vi
...
17. Install bootloader
	...
	2. # grub-install --target=x86_64-efi /dev/<disk> --efi-directory=/boot/grub --bootloader-id=GRUB
...
23. Set journal size
    1. Add the following to /etc/systemd/journald.conf.d/00-journal-size.conf. Create file and directory if missing.
	   ...
	   - SystemMaxUse=30M
24. Install GUI
    1. # pacman -S xorg-server xf96-video-<[intel|amd]> xorg-xinit i3-gaps picom rofi
	2. Edit .xinitrc of the non-root user.
	   - $ nvim .xinitrc
	   - Append the following line
	     - exec i3
25. Install essential applications
    1. # pacman -S firefox chromium kitty pcmanfm-gtk3 vlc papirus-icon-theme lxappearance alsa-utils pulseaudio pulseaudio-alsa volumeicon connman dunst xorg-xbacklight
